$(document).ready(function() {
  ...
  jQuery('.right-banner,.cmsrightbanner').wrapAll('<div class="slider-right col-sm-5"><div class="row"></div></div>'); 
  jQuery('.tt-homeslider,.slider-right').wrapAll('<div class="slider-banner"><div class="container"><div class="row"></div></div></div>');
  /*--------------- Scroll to top js -------------------*/
  ...
  jQuery("#tt-megamenu1 li.tt_menu_item.tt_mm_hassub").hover(
    function () {
  ...
  jQuery(".dark-light-mode .dark-mode").on("click", function(event) {    
    jQuery('body').addClass('darkmode');
  });
  jQuery(".dark-light-mode .light-mode").on("click", function(event) {    
...
/*---------------------------END-------------------------------*/
  ...
  $('.slider-bestproduct-inner').each(function () { 
  ...
  $(".slider-bestproduct-inner .customNavigation .next").click(function(){
    var wrap = $(this).closest('.slider-bestproduct-inner');
    $(wrap).find('.slider-bestproduct').trigger('next.owl');
  });
  $(".slider-bestproduct-inner .customNavigation .prev").click(function(){
    var wrap = $(this).closest('.slider-bestproduct-inner');
...
function responsiveMenu(){
  if(jQuery(window).width() < 992) {
    ...
    $('.header_1 .main-header .right-link-icon .customer_account .header_currency').appendTo('.header_1_wrapper .top_header_1 .top-header');
    $('.header_1 .main-header .right-link-icon .customer_account .header_language').appendTo('.header_1_wrapper .top_header_1 .top-header');
    $('.header_1 .track-order').prependTo('.header_1_wrapper .top_header_1 .top-header');
    $('.header_1 .topright-header').insertAfter('.header_1_wrapper .top_header_1 .top-header');
    $('.header_1 .flash-sale').insertAfter('.header_1_wrapper .top_header_1 .topright-header');
